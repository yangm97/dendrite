...
# starts a travis fold section. The first argument is the name of the fold section
# (which appears on the RHS) and may contain no spaces. Remaining arguments are
# echoed in yellow on the LHS as the header line of the fold section.
travis_sections=()
